export default function Footer() {
  return (
    <footer className="bg-gray-100 text-gray-800 text-sm mt-10 border-t border-gray-300">
      <div className="max-w-5xl mx-auto px-4 py-6 text-justify leading-relaxed space-y-4">
        <p>
          ...
          दिन-रात एक किए हुए हैं। बस, आम लोगों की जानकारी के लिए, नेक्स्ट.जेएस पर बनी वेबसाइट वर्सेल पर मुफ्त में होस्ट हो सकती है वर्ना बाजार में ठग बैठे हैं और हर साल आपसे पैसा वसूलेंगे, जबकि मैं सिर्फ एक बार मजदूर लूँगा और ताला-कुंजी सब आपके हवाले कर दूँगा। 
        </p>

        <p className="text-center text-base font-semibold">
          संपर्क: <a href="mailto:hamaramorcha1153@gmail.com" className="text-blue-600 hover:underline">hamaramorcha1153@gmail.com</a>, मो. <a href="tel:9996865069" className="text-blue-600 hover:underline">9996865069</a>
        </p>
      </div>
    </footer>
  );
